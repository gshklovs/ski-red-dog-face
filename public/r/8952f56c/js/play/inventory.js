...
`;let ea=!1;function pi(){if(ea||typeof document>"u")return;ea=!0;const t=document.createElement("style");t.id="lk-css",t.textContent=ci,document.head.appendChild(t)}let ot=null,it="y",Bt=null;const ta=()=>{if(Bt)return Bt;let t=null;try{t=window.__guide||null}catch{t=null}return!t||!t.layTrail?null:{lay:(r,u)=>t.layTrail(r,u||{}),clear:()=>t.clearTrail(),state:()=>t.trailState()}},rt=()=>{const t=ta();return t?t.state():null};function Ti({THREE:t,model:r,unitScale:u,ctrl:p,onEquip:w,initial:k,world:l,upAxis:E,trail:v}){pi(),l&&(ot=l,it=E==="z"?"z":"y"),v&&(Bt=v);const x=u||1;let A=!1,q=Math.max(0,R.findIndex(e=>e.id==="skis")),c="all",m="looks",g=0,_=[],B="",H=new Map,D=null;try{D=new URLSearchParams(location.search)}catch{D=null}const C={skis:k&&k.skis||Ba,glider:k&&k.glider||ja,bike:k&&k.bike||Ka,sled:k&&k.sled||(D?no(D):Ja),snowmobile:k&&k.snowmobile||(D?co(D):ro),boots:Ro("boots")||"boots",outfit:k&&k.outfit||mo()},U=i("div","lk");U.hidden=!0;const Ut=i("section","lk__panel"),jt=i("div","lk__hd"),Gt=i("div","lk__title");Gt.innerHTML="equipment <b>locker</b>";const Wt=i("div","lk__load"),Re={};for(const e of R){if(e.id==="boots"||e.kind==="settings"||e.kind==="trail"||e.kind==="keys"||e.kind==="board")continue;const n=i("div","lk__load-i"),a=i("span","lk__load-v","—");n.append(i("span","lk__load-k",e.label),a),Wt.append(n),Re[e.id]=a}jt.append(Gt,i("span","lk__spacer"),Wt);const Kt=i("div","lk__tabs"),st=R.map((e,n)=>{const a=i("button","lk__tab");a.type="button",a.style.setProperty("--lk-tab-acc",e.accent||"#4cc9f0");const o=i("span","lk__tab-ic");o.innerHTML=zo(e.icon);const s=i("span","lk__tab-n","0");return a.append(o.firstChild,i("span","lk__tab-l",e.label),s),a.addEventListener("click",h=>{h.stopPropagation(),be(n)}),Kt.append(a),{b:a,n:s}}),Ht=i("div","lk__main"),Vt=i("div","lk__pv"),xe=i("div","lk__stage"),Se=i("div","lk__eqflash");xe.append(Se);const Yt=i("div","lk__plate"),Zt=i("div","lk__plate-brand",""),Qt=i("div","lk__plate-name","—"),$t=i("div","lk__plate-tag","");Yt.append(Zt,Qt,$t),Vt.append(xe,Yt);const Xt=i("div","lk__mid"),ue=i("div","lk__subs");ue.hidden=!0;const Pe=i("div","lk__filters"),fe=i("div","lk__tsearch"),L=i("input","lk__tsearch-i");L.type="text",L.placeholder="search runs",L.spellcheck=!1,L.autocomplete="off",L.autocapitalize="off",L.setAttribute("aria-label","search runs");const Jt=i("span","lk__tsearch-n","");fe.append(i("span","lk__tsearch-ic","/"),L,Jt),fe.hidden=!0;const en=i("div","lk__bars");en.append(ue,Pe,fe);const G=i("div","lk__grid");Xt.append(en,G);const te=i("div","lk__det"),ne=i("div","lk__hero"),ke=i("div","lk__hero-bg"),Q=i("img","lk__hero-img");Q.alt="";const ae=i("div","lk__hero-eq","equipped");ae.hidden=!0,ne.append(ke,Q,ae);const O=i("div","lk__map"),K=i("canvas","lk__mapcv");K.setAttribute("data-map","trails");const lt=i("div","lk__map-t","palisades · winter 2025-26");O.append(K,lt),O.hidden=!0;let N=null,M=null,dt=0,ct=0,pt=null;const tn=i("div","lk__d-head"),ge=i("div","lk__d-brand",""),ht=i("div","lk__d-after",""),me=i("div","lk__d-name","—"),oe=i("div","lk__d-spec","");tn.append(ge,ht,me,oe);const ie=i("div","lk__d-blurb",""),$=i("div","lk__stats"),nn=i("div","lk__cmp"),P=i("div","lk__facts");te.append(ne,O,tn,ie,$,P);function re(){if(!A||y().kind!=="trail"||O.hidden)return null;const e=K.clientWidth||O.clientWidth||300,n=Math.round(Math.max(140,Math.min(330,e*(ve/_e))));Math.abs(O.clientHeight-n)>4&&(O.style.height=n+"px");const a=Math.max(60,Math.round(K.clientWidth||e)),o=Math.max(60,Math.round(K.clientHeight||n));return(!M||a!==dt||o!==ct)&&(M=di(a,o),dt=a,ct=o),nt(M,a,o),N=at(K,M),!pt&&N&&(pt=N),!Ce&&!Ne?li().then(()=>{lt.textContent=Ne?"sheet unavailable":"palisades · winter 2025-26",A&&y().kind==="trail"&&!O.hidden&&re()}):Ne&&(lt.textContent="sheet unavailable"),N}const V=new Map;let Ee=0;const ut=e=>{const n=K.getBoundingClientRect();return{x:e.clientX-n.left,y:e.clientY-n.top}};function ft(e,n,a){if(!M)return;const o=N?N.w:K.clientWidth,s=N?N.h:K.clientHeight,h=M.scale,b=Math.max(ye(o,s),Math.min(ye(o,s)*Xn,h*a));b!==h&&(M.ox=e-(e-M.ox)*(b/h),M.oy=n-(n-M.oy)*(b/h),M.scale=b,nt(M,o,s),N=at(K,M))}O.addEventListener("wheel",e=>{if(O.hidden||!M)return;e.preventDefault();const n=ut(e);ft(n.x,n.y,Math.exp(-e.deltaY*.0022))},{passive:!1}),O.addEventListener("pointerdown",e=>{if(!O.hidden){if(V.set(e.pointerId,ut(e)),V.size===2){const[n,a]=[...V.values()];Ee=Math.hypot(n.x-a.x,n.y-a.y)||0}try{O.setPointerCapture(e.pointerId)}catch{}O.classList.add("is-drag")}}),O.addEventListener("pointermove",e=>{const n=V.get(e.pointerId);if(!n||!M)return;const a=ut(e);V.set(e.pointerId,a);const o=N?N.w:K.clientWidth,s=N?N.h:K.clientHeight;if(V.size>=2){const[h,b]=[...V.values()],f=Math.hypot(h.x-b.x,h.y-b.y);Ee>4&&f>4&&ft((h.x+b.x)/2,(h.y+b.y)/2,f/Ee),Ee=f;return}M.ox+=a.x-n.x,M.oy+=a.y-n.y,nt(M,o,s),N=at(K,M)});const an=e=>{V.delete(e.pointerId),V.size<2&&(Ee=0),V.size||O.classList.remove("is-drag");try{O.releasePointerCapture(e.pointerId)}catch{}};O.addEventListener("pointerup",an),O.addEventListener("pointercancel",an),O.addEventListener("dblclick",e=>{O.hidden||(e.preventDefault(),M=null,re())}),Ht.append(Vt,Xt,te);const Te=i("div","lk__foot"),na=[[["←","→","↑","↓"],"navigate"],[["enter"],"equip"],[["q","e"],"tabs"],[["f"],"filter"],[["1-9"],"quick equip"]];for(const[e,n]of na){const a=i("span","lk__hint");for(const o of e)a.append(i("kbd","lk__key",o));a.append(i("span",null,n)),Te.append(a)}const Ae=i("span","lk__hint");Ae.append(i("kbd","lk__key","t"),i("span",null,"go there")),Ae.hidden=!0,Te.append(Ae),Te.append(i("span","lk__foot-sp"));const on=i("span","lk__hint");on.append(i("kbd","lk__key","esc"),i("span",null,"close")),Te.append(on),Ut.append(jt,Kt,Ht,Te),U.append(Ut),document.body.appendChild(U);let d=null;function aa(){const e=new t.Scene;e.add(new t.HemisphereLight(16777215,3816004,1.35));const n=new t.DirectionalLight(16777215,1.05);n.position.set(3,5,4);const a=new t.DirectionalLight(16767432,.5);a.position.set(-4,2,-3),e.add(n,a);const o=new t.Group;e.add(o);const s=r?r.clone(!0):new t.Group,h=r&&r.getObjectByName("play:body"),b=h?_o(h):null,f=b?wo(b):null;if(f){const I=s.getObjectByName("play:body");I&&I.parent?(I.parent.add(f.model),I.parent.remove(I)):s.add(f.model),f.skeleton.pose(),f.model.updateMatrixWorld(!0)}s.position.set(0,0,0),s.rotation.set(0,0,0);const S=[];s.traverse(I=>{const vn=ko(I.name||"")!=null&&r.getObjectByName(I.name);vn?S.push([I,vn]):I.visible=!0});const z=new Set;f&&f.model.traverse(I=>{I.isMesh&&/^rider:/.test(I.name||"")&&I.material&&z.add(I.material)});const F=f?new Map([...f.riderMats].filter(([,I])=>z.has(I))):new Map,St=f?f.riderToggles:[],pe=/^play:(?:fp-|tp-)|^play:ski-[lr]$|^play:rocket-pack$/;s.traverse(I=>{I.name&&pe.test(I.name)&&(I.visible=!1)});const We=s.getObjectByName("play:tp-glider"),he=s.getObjectByName("play:body"),Ra=s.getObjectByName("play:rocket-pack"),Et=he?he.getObjectByName("rider:body"):null,Pa=Et?new t.AnimationMixer(Et):null,_n=new Map;for(const I of he&&he.animations||[])_n.set(I.name,I);o.add(s);const Tt=yn(t,x),At=yn(t,x);Tt.position.set(-.15*x,.02*x,0),At.position.set(.15*x,.02*x,0),o.add(Tt,At);const Mt=Ya(t,x);Mt.visible=!1,o.add(Mt);const Lt=ao(t,x);Lt.visible=!1,o.add(Lt);const It=po(t,x,{model:C.snowmobile});It.visible=!1,o.add(It);const qa=new t.PerspectiveCamera(34,1,.05*x,80*x),Ke=new t.WebGLRenderer({alpha:!0,antialias:!0});Ke.setPixelRatio(Math.min(2,window.devicePixelRatio||1)),Ke.domElement.className="lk__canvas",xe.insertBefore(Ke.domElement,Se),d={scene:e,camera:qa,renderer:Ke,turntable:o,skiL:Tt,skiR:At,bike:Mt,sled:Lt,snow:It,cGlide:We,cBody:he,cPack:Ra,cSkin:Et,mixer:Pa,clips:_n,clip:null,want:null,riderPairs:S,riderMats:F,riderToggles:St,tryOn:null,t:0,kick:0},qe()}function qe(){if(!d)return;const e=Math.max(80,xe.clientWidth),n=Math.max(80,xe.clientHeight),a=Math.max(80,Math.min(n,Math.round(e*4/3)));d.renderer.setSize(e,a,!1),d.renderer.domElement.style.height=a+"px",d.renderer.domElement.style.top=Math.round((n-a)/2)+"px",d.camera.aspect=e/a,d.camera.updateProjectionMatrix()}function oa(e){if(!d||!d.mixer||d.want===e)return;d.want=e;const n=d.clips.get(e)||d.clips.get("idle-boots")||d.clips.get("ski-stance");if(!n||d.clip===n.name)return;d.mixer.stopAllAction();const a=d.mixer.clipAction(n);a.reset(),a.enabled=!0,a.setEffectiveWeight(1),a.play(),d.clip=n.name,d.mixer.setTime(0)}function ia(e,n){if(!d)return;const a=e.kind==="outfit",o=e.kind==="ski"||a,s=e.kind==="glider"&&n?n.preview:null,h=s==="wing",b=e.kind==="bike",f=e.kind==="sled",S=e.kind==="snowmobile",z=b||f||S;if(d.skiL.visible=d.skiR.visible=o,d.cGlide&&(d.cGlide.visible=h),d.cBody&&(d.cBody.visible=!0),d.cPack&&(d.cPack.visible=s==="pack"),oa(b?"seat-bike":f?"seat-sled":S?"seat-snowmobile":h?"prone-glider":"idle-boots"),d.cBody&&(d.cBody.position.set(0,h?1.05*x:0,0),d.cBody.rotation.x=d.cBody.rotation.y=d.cBody.rotation.z=0,b&&n)){const F=$a(Qa(n.id));d.cBody.position.y+=(F.hip[0]-1.053)*x,d.cBody.position.z+=(F.hip[1]-.305)*x}if(d.bike.visible=b,d.sled.visible=f,d.snow.visible=S,b&&n&&Za(t,d.bike,n.id),f&&n&&oo(t,d.sled,n.id),S&&n&&ho(t,d.snow,n.id),o&&n){const F=a?C.skis:n.id;xn(t,d.skiL,F),xn(t,d.skiR,F)}if(a&&n){const F=m==="looks"?n.id:sa(n.id);He(t,d,F),d.tryOn=F}else d.tryOn!=null&&(He(t,d,window.__player?.outfit),d.tryOn=null)}const ra=.28;let Fe=0,kt=0;function rn(e){if(!A){Fe=0;return}Fe=requestAnimationFrame(rn);const n=Math.min(.05,(e-kt)/1e3||0);if(kt=e,!d)return;d.hold==null&&(d.t+=n),d.turntable.rotation.y=d.hold==null?d.turntable.rotation.y+n*(ra+d.kick):d.hold,d.mixer&&(d.hold==null?d.mixer.update(n):d.mixer.setTime(0)),d.kick*=Math.exp(-n*3.4),d.kick<.001&&(d.kick=0);const a=Math.tan(d.camera.fov*Math.PI/180/2),o=Math.max(1.12/a,1.3/(a*Math.max(.25,d.camera.aspect)))*x;if(d.camera.position.set(0,(1.3+.012*Math.sin(d.t*.7))*x,o),d.camera.lookAt(0,.86*x,0),d.tryOn==null)for(const[s,h]of d.riderPairs)s.visible=h.visible;d.renderer.render(d.scene,d.camera)}const y=()=>R[q],Y=new Set;function X(e){try{const n=e.items(e.kind==="outfit"?m:void 0);if(Array.isArray(n))return Y.delete(e.id),n}catch(n){Y.has(e.id)||console.warn(`[locker] rack "${e.id}" unavailable:`,n&&n.message)}return Y.add(e.id),[]}function sn(e){const n=[];for(const a of e)a.group&&!n.includes(a.group)&&n.push(a.group);return n}function ze(){const e=y();if(e.kind!=="outfit")return C[e.id];const n=Ct(C.outfit);return m==="looks"?n.every(a=>a===n[0])?n[0]:null:n[Ve.indexOf(m)]}const sa=e=>bo(Ct(C.outfit).map((n,a)=>a===Ve.indexOf(m)?e:n));function la(){const e=y().kind==="outfit";if(ue.hidden=!e,!!e){ue.textContent="",ue.append(i("kbd","lk__key","g"));for(const n of Oe){const a=i("button","lk__chip");a.type="button",a.style.setProperty("--g",y().accent||"#4cc9f0"),a.append(document.createTextNode(n)),a.classList.toggle("is-on",m===n),a.addEventListener("click",o=>{o.stopPropagation(),gt(n)}),ue.append(a)}}}function gt(e){return Oe.includes(e)&&e!==m&&(m=e,g=0,Ie()),m}function da(){const e=y().accent||"#4cc9f0";U.style.setProperty("--lk-acc",e),U.style.setProperty("--lk-acc-soft",Qe(e,.18)),U.style.setProperty("--lk-acc-dim",Qe(e,.34))}function ca(){R.forEach((e,n)=>{st[n].n.textContent=String(X(e).length),st[n].b.hidden=Y.has(e.id)})}function mt(){for(const e of R){if(!Re[e.id])continue;const n=X(e).find(a=>a.id===C[e.id]);Re[e.id].parentElement.hidden=Y.has(e.id),Re[e.id].textContent=e.kind==="outfit"?pa():n?n.name:"—"}}function pa(){const e=[...new Set(Ct(C.outfit))];if(e.length>1)return"mix · "+e.length+" houses";const n=fo[e[0]];return n?Xe(n)+" · "+n.name:"—"}function ha(){const e=X(y()),n=sn(e);if(Pe.textContent="",Pe.hidden=n.length<2,n.length<2)return;const a={all:e.length};for(const o of n)a[o]=e.filter(s=>s.group===o).length;for(const o of y().noAll?n:["all",...n]){const s=i("button","lk__chip");s.type="button",s.style.setProperty("--g",o==="all"?y().accent||"#4cc9f0":qt(o)),s.append(document.createTextNode(o),i("i",null,String(a[o]))),s.classList.toggle("is-on",c===o),s.addEventListener("click",h=>{h.stopPropagation(),c=o,g=0,Ie()}),Pe.append(s)}}const ln=new WeakMap;function dn(e,n){const a=ln.get(e);if(!a)return;const o=Ye(n);a.el.classList.toggle("is-on",o),a.v.textContent=o?"on":"off",e.setAttribute("aria-checked",o?"true":"false")}function ua(e,n){const a=i("button","lk__row");a.type="button",a.setAttribute("role","switch");const o=i("span","lk__row-txt");o.append(i("span","lk__row-t",e.name),i("span","lk__row-d",e.desc||""));const s=i("span","lk__sw"),h=i("span","lk__sw-v","off");return s.append(i("span","lk__sw-t"),h),ln.set(a,{el:s,v:h}),a.append(o,s),dn(a,e.key),a.addEventListener("click",b=>{b.stopPropagation(),g=n,T(),le()}),a.addEventListener("mouseenter",()=>{g=n,T()}),G.append(a),a}function De(e){let n=null;try{n=window.__playMarkers&&window.__playMarkers.fastTravel(e.slug)}catch{n=null}if(!n&&e.at&&window.__player&&typeof window.__player.teleport=="function")try{window.__player.teleport(e.at.x,e.at.y,e.at.z),n=!0}catch{n=null}return ce(),!!n}function fa(e){let n=null;try{const a=window.__guide;a&&typeof a.startTutorial=="function"&&(n=a.startTutorial(e.tut))}catch{n=null}return ce(),n}function ka(e){if(!e)return null;if(e.section==="tutorials"&&e.tut)return fa(e);if(!e.canEquip)return De(e);const n=ta();if(!n)return De(e);const a=n.lay(e.segments&&e.segments.length>1?e.segments:e.id,{name:e.name});if(se(),De(e),a&&a.start&&Number.isFinite(a.start.yaw))try{window.__player.setYaw(a.start.yaw)}catch{}return a}let bt=!1;G.addEventListener("pointermove",()=>{bt=!0},{passive:!0});function ga(e){const n=String(e.name||""),a=H.get(e);if(!a||!a.length)return i("span","lk__trow-n",n);const o=i("span","lk__trow-n"),s=new Set(a);let h="",b=s.has(0);for(let f=0;f<=n.length;f++){const S=f<n.length&&s.has(f);(f===n.length||S!==b)&&(h&&o.append(b?i("i","lk__hl",h):document.createTextNode(h)),h="",b=S),f<n.length&&(h+=n[f])}return o}function ma(e,n){const a=!!B.trim(),o=_[n-1];!a&&(!o||o.section!==e.section)&&G.append(i("div","lk__tsec",e.section==="tutorials"?"tutorials · learn the run":e.section==="places"?"places · fast travel":"runs · equip a trail"));const s=i("button","lk__row lk__trow");s.type="button",s.setAttribute("data-slug",e.slug),s.setAttribute("data-id",e.id),s.setAttribute("data-sec",e.section||"runs");const h=we[e.diff]||null,b=i("span","lk__mark"+(h?" "+h.cls:""));h&&b.setAttribute("aria-label",h.label);const f=i("span","lk__row-txt");f.append(ga(e)),e.also&&f.append(i("span","lk__trow-a",e.also)),s.append(b,f,i("span","lk__trow-k",e.kind||""),i("span","lk__trow-s",e.slug));const S=rt();return S&&S.id===e.id&&s.classList.add("is-eqt"),s.addEventListener("click",z=>{z.stopPropagation(),g=n,T(),le()}),s.addEventListener("mouseenter",()=>{bt&&(g=n,T())}),G.append(s),s}let W=null,Be=!1;const cn=new WeakMap,ba=new Set(["Escape","Tab","F1","F2","F3","F4","F5","F6","F7","F8","F9","F10","F11","F12"]);function pn(e,n){const a=cn.get(e);if(!a||!n)return;if(n.isReset){a.textContent="RESET";return}const o=W===n.action;a.textContent=o?"PRESS A KEY":Ze(n.action),a.classList.toggle("is-live",o),e.classList.toggle("is-rebound",!o&&!Rt(n.action))}function Ue(){y().kind==="keys"&&j.forEach((e,n)=>pn(e,_[n]))}function hn(){W!==null&&(W=null,Ue(),T())}function un(e){const n=W;W=null,n&&To(n,e),Ue(),T()}function wa(e){if(W!==null){if(e.preventDefault(),e.stopPropagation(),e.type!=="pointerdown")return;Be=!0;const n=Eo(e.button);n?un(n):hn();return}if(e.type==="pointerdown"){Be=!1;return}Be&&(e.preventDefault(),e.stopPropagation(),e.type==="click"&&(Be=!1))}for(const e of["pointerdown","pointerup","click","contextmenu"])U.addEventListener(e,wa,!0);function _a(e,n){const a=i("button","lk__row lk__krow"+(e.isReset?" is-rst":""));a.type="button",a.setAttribute("data-action",e.action||"reset");const o=i("span","lk__row-txt");o.append(i("span","lk__row-t",e.name));const s=i("span","lk__kchip");return a.append(o,s),cn.set(a,s),pn(a,e),a.addEventListener("click",h=>{h.stopPropagation(),g=n,T(),le()}),a.addEventListener("mouseenter",()=>{W===null&&(g=n,T())}),G.append(a),a}function va(e,n){const a=i("button","lk__row lk__brow");a.type="button",a.setAttribute("data-board",e.board),a.setAttribute("data-target",e.target||"");const o=we[e.diff]||null,s=i("span","lk__mark"+(o?" "+o.cls:""));o&&s.setAttribute("aria-label",o.label);const h=i("span","lk__row-txt");h.append(i("span","lk__row-t",e.name));const b=i("span","lk__brow-n",e.n==null?"":e.n+(e.n===1?" skier":" skiers"));return a.append(s,h,b,i("span","lk__trow-k",e.tail||"")),a.addEventListener("click",f=>{f.stopPropagation(),g=n,T()}),a.addEventListener("mouseenter",()=>{g=n,T()}),G.append(a),a}let j=[],wt=[];function se(){const e=y(),n=X(e);wt=Bo(n),_=c==="all"?n:n.filter(o=>o.group===c),_.length||(_=n),H=new Map,bt=!1;const a=_.length;if(e.kind==="trail"&&B.trim()){const o=[];for(const s of _){const h=ri(s,B.trim());h&&o.push({it:s,m:h})}o.sort((s,h)=>h.m.score-s.m.score||String(s.it.name).length-String(h.it.name).length||String(s.it.name).localeCompare(String(h.it.name))),_=o.map(s=>(H.set(s.it,s.m.pos),s.it))}if(Jt.textContent=e.kind==="trail"&&B.trim()?`${_.length}/${a}`:"",g=Math.max(0,Math.min(g,_.length-1)),G.textContent="",G.classList.toggle("is-rows",e.kind==="settings"||e.kind==="trail"||e.kind==="keys"||e.kind==="board"),G.classList.toggle("is-trails",e.kind==="trail"),e.kind==="settings"){j=_.map(ua),T();return}if(e.kind==="trail"){j=_.map(ma),T();return}if(e.kind==="keys"){j=_.map(_a),T();return}if(e.kind==="board"){j=_.map(va),T();return}j=_.map((o,s)=>{const h=qt(o.group),b=i("button","lk__card");b.type="button",b.style.setProperty("--g",h),b.style.setProperty("--g-wash",Qe(h,.16)),b.style.setProperty("--g-glow",Qe(h,.55));const f=i("span","lk__art"),S=i("img","lk__img");S.alt="",o.thumb?S.src=o.thumb:S.hidden=!0,f.append(S),o.group&&f.append(i("span","lk__gchip",o.group));const z=[i("span","lk__brand",o.brand||"")];return o.after&&z.push(i("span","lk__after",o.after)),b.append(f,...z,i("span","lk__name",o.name),i("span","lk__tag",o.tag||"")),ze()===o.id&&(b.append(i("span","lk__eq","equipped")),b.classList.add("is-eq")),b.addEventListener("click",F=>{F.stopPropagation(),g=s,T(),le()}),b.addEventListener("mouseenter",()=>{g=s,T()}),G.append(b),b}),T()}const fn=[];function ya(e){const n=X(y()).find(o=>o.id===C[y().id])||null,a=n&&n.id===e.id;$.textContent="",fn.length=0;for(const o of wt){const s=Pn(o,e.stats[o.key]),h=n&&Ft(n.stats[o.key])?Pn(o,n.stats[o.key]):s,b=i("div","lk__stat"),f=i("span","lk__stat-t"),S=i("i"),z=i("u"),F=Math.min(s,h);S.style.width=(F*100).toFixed(1)+"%",!a&&Math.abs(s-h)>.004?(z.style.left=(F*100).toFixed(1)+"%",z.style.width=(Math.abs(s-h)*100).toFixed(1)+"%",z.classList.add(s>h?"is-up":"is-down")):S.style.width=(s*100).toFixed(1)+"%",f.append(S,z);const St=i("span","lk__stat-v",String(Math.round(s*100))),pe=Math.round((s-h)*100),We=i("span","lk__stat-d",a||pe===0?"":(pe>0?"+":"−")+Math.abs(pe));!a&&pe!==0&&We.classList.add(pe>0?"is-up":"is-down");const he=o.src&&Ft(e.stats[o.src])?e.stats[o.src]:e.stats[o.key];b.title=`${o.label}: ${he.toFixed(2)}${o.suffix||""}`,b.append(i("span","lk__stat-k",o.label),f,St,We),$.append(b),fn.push(b)}wt.length&&(nn.textContent=a||!n?"equipped":"vs "+n.name,$.append(nn))}function xa(e){te.style.setProperty("--g",y().accent),Q.hidden=!0,ke.style.backgroundImage="none",ae.hidden=!0,ne.hidden=!0,$.textContent="",ge.textContent="settings",me.textContent=e.name,oe.textContent=Ye(e.key)?"on":"off",ie.textContent=e.desc||"",P.textContent="";for(const[n,a]of[["state",Ye(e.key)?"on":"off"],["default",e.def?"on":"off"]]){const o=i("div","lk__fact");o.append(i("span","k",n),i("span","v",a)),P.append(o)}}function Sa(e){if(te.style.setProperty("--g",y().accent),Q.hidden=!0,ke.style.backgroundImage="none",ae.hidden=!0,ne.hidden=!0,$.textContent="",ge.textContent="keybind",me.textContent=e.name,P.textContent="",e.isReset){oe.textContent="every action",ie.textContent="Puts all nineteen controls back to the keys this build ships with, and clears the saved layout from this device.";return}const n=W===e.action;oe.textContent=n?"press a key":Ze(e.action);const a=Mo(e.action);ie.textContent=n?"Press any key, or a mouse button, to bind it. If that key is already doing another job the two SWAP — nothing is left without a key. Escape cancels.":a?"Click the row to rebind the SECOND key. ESC opens the board on every machine and cannot be moved or taken, so it stays; the key beside it is yours, it swaps with whatever already holds it, and every legend follows.":"Click the row to rebind. A key already in use swaps with this one, and every legend in the game — the intro card, the ESC board, the strip along the bottom — follows what you bind.";const o=(xo[e.action]||[]).map(So);for(const[s,h]of[["key",Ze(e.action)],["default",[...new Set(o)].join(" · ")||"—"],["code",In(e.action).join(" · ")||"—"],["saved",Rt(e.action)?"shipped":"yours"]]){const b=i("div","lk__fact");b.append(i("span","k",s),i("span","v",String(h))),P.append(b)}}function Ea(e){te.style.setProperty("--g",y().accent),Q.hidden=!0,ke.style.backgroundImage="none",ae.hidden=!0,ne.hidden=!0,O.hidden=!1,$.textContent="",ge.textContent=e.kind||"waypoint",me.textContent=e.name,oe.textContent=e.diff?we[e.diff]?we[e.diff].label:e.diff:"unrated";const n=rt(),a=!!(n&&n.id===e.id);ie.textContent=e.section==="tutorials"?"The guided run. One click equips it, stands you at the top and starts the lesson: "+(e.also||"the run, taught")+". Hold X any time to leave it; finishing lands you in free ride at the base.":e.canEquip?a?"Equipped. The dye and the chevrons are down this run. Click it again to go back to the top. F clears them — unless you are standing at a lift base, where F still boards.":"One click equips this run and drops you in at the top of it: dye and chevrons the whole way down, and the locker gets out of the way.":"Fast travel. You arrive short of the sign, on the floor, looking at it. T does the same.",P.textContent="";const o=e.at||{},s=[["slug",e.slug],["also",e.also||"—"],["road",e.section==="tutorials"?"tutorial · enter":e.viaSign?"sign · T":"waypoint"],["east",Number.isFinite(o.x)?Math.round(o.x)+" m":"—"],["north",Number.isFinite(o.z)?Math.round(-o.z)+" m":"—"]];a?(s.push(["trail",Math.round(n.lengthM)+" m"]),s.push(["chevrons",n.arrows+" · every "+n.spacingM+" m"]),s.push(["dye",n.widthM+" m wide"])):e.canEquip&&s.push(["trail","click to equip · go"]);for(const[h,b]of s){const f=i("div","lk__fact");f.append(i("span","k",h),i("span","v",String(b))),P.append(f)}Ta(e),re()}function Ta(e){if(!e||!e.canEquip)return;const n=je();if(!n||!n.hasApi())return;const a=++Me,o="trick:"+e.id,s=b=>{if(a!==Me)return;const f=(b&&Array.isArray(b.rows)?b.rows:[]).slice(0,3);if(!f.length)return;P.append(i("div","lk__bcut","top tricks"));const S=i("div","lk__board");for(const z of f)S.append(vt("trick",z,gn(z)));P.append(S)},h=J.get(o);if(h&&Date.now()-h.at<kn){s(h.data);return}n.board("trick",e.id).then(b=>{J.set(o,{at:Date.now(),data:b}),s(b)}).catch(()=>{})}let Me=0;const J=new Map,kn=2e4,je=()=>{try{return window.__playNet||null}catch{return null}},Aa=e=>{const n=Math.max(0,Number(e)||0)/1e3,a=Math.floor(n/60),o=n-a*60;return a>0?`${a}:${o.toFixed(2).padStart(5,"0")}`:o.toFixed(2)+"s"},Ma=e=>String(Math.round(Number(e)||0)).replace(/\B(?=(\d{3})+(?!\d))/g,","),La=(e,n)=>e==="race"?Aa(n):Ma(n),Ia=[[864e5*365,"y"],[864e5*30,"mo"],[864e5,"d"],[36e5,"h"],[6e4,"m"]];function Oa(e){const n=Date.now()-(Number(e)||0);if(n<6e4)return"just now";for(const[a,o]of Ia)if(n>=a)return Math.floor(n/a)+o+" ago";return"just now"}function Ca(e){te.style.setProperty("--g",y().accent),Q.hidden=!0,ke.style.backgroundImage="none",ae.hidden=!0,ne.hidden=!0,$.textContent="",ge.textContent=e.board==="race"?"race times":e.board==="trick"?"trick scores":"overall",me.textContent=e.name,oe.textContent=e.sub||"",ie.textContent=e.board==="race"?"Fastest clean run per skier. A single missed gate is no time — the run does not land on this board.":e.board==="trick"?"Best single combo per skier on this run. The run is the one the combo STARTED on.":"Best single combo per skier, anywhere on the mountain — off-piste lines included.",P.textContent="";const n=++Me,a=e.board+":"+(e.target||"");P.append(mn());const o=je();if(!o||!o.hasApi()){P.append(Le("no leaderboard server in this build"));return}const s=J.get(a);if(s&&Date.now()-s.at<kn){_t(e,s.data);return}P.append(Le("loading…")),o.board(e.board,e.target).then(h=>{n===Me&&(J.set(a,{at:Date.now(),data:h}),_t(e,h))}).catch(()=>{n===Me&&_t(e,null)}),(!Je||Date.now()-Kn>6e4)&&(Kn=Date.now(),o.boardIndex().then(h=>{h&&(Je=h,se())}).catch(()=>{}))}const Le=e=>i("div","lk__bnote",e);function _t(e,n){if(P.textContent="",P.append(mn()),!n){P.append(Le("the leaderboard is not answering — the game does not need it"));return}const a=Array.isArray(n.rows)?n.rows:[];if(!a.length){P.append(Le(e.board==="race"?"no clean runs yet. Be first.":"no scores yet. Be first."));return}const o=i("div","lk__board");for(const s of a)o.append(vt(e.board,s,gn(s)));n.you&&n.youIn===!1&&(o.append(i("div","lk__bcut","you")),o.append(vt(e.board,n.you,!0))),P.append(o),P.append(Le(n.n+(n.n===1?" skier":" skiers")+" on this board"))}function gn(e){const n=je(),a=n&&n.player();return!!(a&&Number(a.id)===Number(e.pid))}function vt(e,n,a){const o=i("div","lk__brow-r"+(a?" is-you":""));return o.append(i("span","lk__b-rank","#"+n.rank),i("span","lk__b-name",n.name||"—"),i("span","lk__b-val",La(e,n.value)),i("span","lk__b-when",Oa(n.at))),o}function mn(){const e=i("div","lk__sign"),n=je();if(!n)return e.append(i("span","lk__sign-n","SIGN-IN NOT CONFIGURED")),e;const a=n.player();if(!a){const f=i("button","lk__sign-b",n.canSignIn()?"GOOGLE SIGN-IN":"SIGN-IN NOT CONFIGURED");f.type="button",f.disabled=!n.canSignIn();const S=i("span","lk__sign-n",n.canSignIn()?"sign in to post your times and scores":"the boards still load — posting is off");return f.addEventListener("click",async z=>{z.stopPropagation(),f.disabled=!0,f.textContent="SIGNING IN…";const F=await n.signIn();if(F.ok){J.clear(),T(),se();return}f.disabled=!1,f.textContent="GOOGLE SIGN-IN",S.textContent=F.why==="cancelled"?"sign-in cancelled":F.why==="blocked"?"the Google script did not load":F.why==="offline"?"the leaderboard server is not answering":"sign-in did not go through"}),e.append(f,S),e}const o=i("input","lk__sign-i");o.type="text",o.value=a.name,o.maxLength=16,o.setAttribute("aria-label","display name"),o.addEventListener("keydown",f=>f.stopPropagation()),o.addEventListener("click",f=>f.stopPropagation());const s=i("span","lk__sign-n",n.queued()?n.queued()+" result(s) waiting to post":"signed in"),h=i("button","lk__sign-b","SAVE NAME");h.type="button",h.addEventListener("click",async f=>{if(f.stopPropagation(),o.value===a.name){s.textContent="that is already your name";return}h.disabled=!0;const S=await n.rename(o.value);if(h.disabled=!1,S.ok){J.clear(),s.textContent="name changed",T();return}s.textContent=S.why==="taken"?"that name is taken":S.why==="shape"?"3-16 letters, digits, space, apostrophe or hyphen":S.why==="cooldown"?"one name change a day — try again tomorrow":"the name did not change",o.value=a.name});const b=i("button","lk__sign-b lk__sign-out","SIGN OUT");return b.type="button",b.addEventListener("click",f=>{f.stopPropagation(),n.signOut(),J.clear(),T(),se()}),e.append(o,h,b,s),e}function T(){j.forEach((o,s)=>o.classList.toggle("is-sel",s===g));const e=_[g];if(Ae.hidden=y().kind!=="trail"||!e||!!e.canEquip,!e)return;if(j[g]&&j[g].scrollIntoView&&j[g].scrollIntoView({block:"nearest"}),O.hidden=y().kind!=="trail",y().kind==="keys"){Sa(e);return}if(y().kind==="board"){Ca(e);return}if(y().kind==="settings"){xa(e);return}if(y().kind==="trail"){Ea(e);return}ne.hidden=!1;const n=qt(e.group);te.style.setProperty("--g",n);const a=ze()===e.id;Q.hidden=!e.thumb,e.thumb&&(Q.src=e.thumb),ke.style.backgroundImage=e.thumb?`url(${e.thumb})`:"none",ae.hidden=!a,ge.textContent=e.brand||"",ht.textContent=e.after||"",ht.hidden=!e.after,me.textContent=e.name,oe.textContent=e.spec||e.tag||"",ie.textContent=e.blurb||"",Zt.textContent=e.brand||"",Qt.textContent=e.name,$t.textContent=(e.tag||"")+(a?" · equipped":""),ya(e),P.textContent="";for(const[o,s]of e.facts||[]){const h=i("div","lk__fact");h.append(i("span","k",o),i("span","v",String(s))),P.append(h)}ia(y(),e)}function Ie(){st.forEach((e,n)=>e.b.classList.toggle("is-on",n===q)),Ae.hidden=!0,da(),ca(),la(),ha(),fe.hidden=y().kind!=="trail",se(),mt()}function yt(e){const n=String(e??"");L.value!==n&&(L.value=n),B!==n&&(B=n,g=0,se())}const bn=()=>{try{return typeof matchMedia=="function"&&matchMedia("(pointer: coarse)").matches}catch{return!1}};function Ge(e){if(fe.hidden||!e&&bn())return!1;try{L.focus({preventScroll:!0}),L.select()}catch{return!1}return document.activeElement===L}L.addEventListener("keydown",e=>{e.stopPropagation();const n=e.code;if(n==="Escape"){if(e.preventDefault(),L.value){yt("");return}L.blur(),ce();return}if(n==="Enter"||n==="NumpadEnter"){e.preventDefault(),_.length&&le();return}if(n==="ArrowDown"||n==="ArrowUp"){if(e.preventDefault(),!_.length)return;g=n==="ArrowDown"?Math.min(_.length-1,g+1):Math.max(0,g-1),T();return}n==="Tab"&&e.preventDefault()}),L.addEventListener("input",()=>yt(L.value)),L.addEventListener("click",e=>e.stopPropagation());function be(e,n=1){const a=q;W=null;let o=(e%R.length+R.length)%R.length;for(let f=0;f<R.length&&(X(R[o]),!!Y.has(R[o].id));f++)o=((o+n)%R.length+R.length)%R.length;q=o,c=R[o].defaultFilter||"all",R[o].kind!=="trail"&&(B="",L.value="",L.blur());const s=rt(),h=R[o].kind==="trail"&&s?s.id:ze(),b=X(y());g=Math.max(0,b.findIndex(f=>f.id===h)),Ie(),a!==q&&(G.classList.remove("is-swap"),G.offsetWidth,G.classList.add("is-swap"))}function le(){const e=y(),n=_[g];if(!n)return;if(e.kind==="trail"){ka(n);return}if(e.kind==="board"){J.delete(n.board+":"+(n.target||"")),T();return}if(e.kind==="keys"){const s=j[g];n.isReset?(Ao(),W=null,Ue(),s&&(s.classList.remove("is-go"),s.offsetWidth,s.classList.add("is-go"))):(W=W===n.action?null:n.action,Ue()),T();return}if(e.kind==="settings"){yo(n.key,!Ye(n.key));const s=j[g];s&&(dn(s,n.key),s.classList.remove("is-go"),s.offsetWidth,s.classList.add("is-go")),T();return}C[e.id]=n.id,e.remember?e.remember(n.id):e.kind==="ski"?Da(n.id):e.kind==="glider"?Ga(n.id):e.kind==="bike"?Va(n.id):No(e.id,n.id),e.apply&&e.apply(n.id,e.kind==="outfit"?m:void 0),e.kind==="outfit"&&(C.outfit=window.__player&&window.__player.outfit||n.id);const a=e.kind==="outfit"?n.brand+" "+(m==="looks"?n.name:n.tag):n.name;w&&w({tab:e.id,gear:n.gear||e.gear||p&&p.mode,kind:e.kind,id:n.id,name:a}),Na(),T(),mt(),d&&e.kind==="outfit"&&d.tryOn===C.outfit&&(d.tryOn=null);const o=j[g];o&&(o.classList.remove("is-go"),o.offsetWidth,o.classList.add("is-go")),Se.classList.remove("is-go"),Se.offsetWidth,Se.classList.add("is-go"),d&&(d.kick=2.6)}function Na(){j.forEach((e,n)=>{const a=e.querySelector(".lk__eq"),o=ze()===_[n].id;o&&!a?e.append(i("span","lk__eq","equipped")):!o&&a&&a.remove(),e.classList.toggle("is-eq",o)})}function wn(){if(y().kind==="settings"||y().kind==="trail"||y().kind==="keys"||y().kind==="board"||!j.length)return 1;const e=j[0].offsetWidth||1,n=10;return Math.max(1,Math.round((G.clientWidth+n)/(e+n)))}let de=0;function xt(){A||(A=!0,de&&(clearTimeout(de),de=0),U.hidden=!1,U.classList.remove("is-out"),M=null,dt=0,ct=0,d?qe():aa(),d&&(He(t,d,window.__player?.outfit),d.tryOn=null),window.__player&&window.__player.outfit&&(C.outfit=window.__player.outfit),be(q),U.offsetWidth,U.classList.add("is-in"),kt=performance.now(),Fe||(Fe=requestAnimationFrame(rn)),requestAnimationFrame(()=>{qe(),re()}))}function ce(){A&&(A=!1,W=null,B="",L.value="",L.blur(),d&&(d.hold=null),d&&d.tryOn!=null&&(He(t,d,window.__player?.outfit),d.tryOn=null),U.classList.remove("is-in"),U.classList.add("is-out"),de&&clearTimeout(de),de=setTimeout(()=>{de=0,A||(U.hidden=!0,U.classList.remove("is-out"))},150))}return addEventListener("resize",()=>{A&&(qe(),re())}),window.__locker=Object.assign(window.__locker||{},{turntable(e){return xt(),d.hold=e==null?null:Number(e),d.t=0,new Promise(n=>requestAnimationFrame(()=>requestAnimationFrame(()=>n(d.turntable.rotation.y))))},tryOn:()=>d?d.tryOn:null,mannequin:()=>d?{body:d.cBody,skin:d.cSkin,clip:d.clip,want:d.want,baked:[...d.clips.keys()],pairs:d.riderPairs.length,mats:d.riderMats.size,toggles:d.riderToggles.length,pos:d.cBody?[d.cBody.position.x,d.cBody.position.y,d.cBody.position.z]:null,visible:!!(d.cBody&&d.cBody.visible),pack:!!(d.cPack&&d.cPack.visible),glider:!!(d.cGlide&&d.cGlide.visible)}:null,sub:()=>m,setSub:gt,thumbMs:()=>Gn,mapSheet:()=>N?{...N,url:$n,first:pt}:null,mapDraw:()=>re(),mapZoomAt:(e,n,a)=>(ft(e,n,a),N),mapPanBy:(e,n)=>!M||!N?null:(M.ox+=e,M.oy+=n,nt(M,N.w,N.h),N=at(K,M),N),mapReset:()=>(M=null,re()),trail:()=>rt(),keys:()=>({listening:W,rows:Ln.map(e=>({id:e.id,name:e.name,chip:Ze(e.id),codes:In(e.id),isDefault:Rt(e.id)}))}),rows:()=>Dt(ot,it).map(e=>({id:e.id,name:e.name,diff:e.diff,section:e.section,segments:e.segments.slice(),canEquip:e.canEquip})),search:()=>({shown:!fe.hidden,focused:document.activeElement===L,q:L.value,placeholder:L.placeholder,n:_.length,names:_.map(e=>e.name),hl:_.map(e=>(H.get(e)||[]).map(n=>String(e.name)[n]).join("")),sel:_[g]?_[g].name:null,coarse:bn()}),setSearch:e=>(yt(e),_.map(n=>n.name)),focusSearch:e=>Ge(e!==!1)}),{root:U,isOpen:()=>A,open:xt,close:ce,toggle(){return A?ce():xt(),A},key(e){if(!A)return!1;if(W!==null)return e==="Escape"?(hn(),!0):(ba.has(e)||un(e),!0);if(e==="Escape"||e==="KeyI")return ce(),!0;if(e==="KeyM"){if(y().kind==="trail")return ce(),!0;const a=R.findIndex(o=>o.kind==="trail"&&!Y.has(o.id));return a>=0&&(be(a),Ge()),!0}if(e==="Slash")return y().kind==="trail"&&Ge(!0),!0;if(e==="KeyQ")return be(q-1,-1),!0;if(e==="KeyE"||e==="Tab")return be(q+1,1),!0;if(e==="KeyF"){const a=["all",...sn(X(y()))];return c=a[(a.indexOf(c)+1)%a.length],g=0,Ie(),!0}if(e==="KeyG")return y().kind==="outfit"&&gt(Oe[(Oe.indexOf(m)+1)%Oe.length]),!0;if(e==="KeyT"){const a=_[g];return y().kind==="trail"&&a&&!a.canEquip&&a.section!=="tutorials"&&De(a),!0}if(!_.length)return!0;if(e==="ArrowLeft"||e==="KeyA")return g=(g+_.length-1)%_.length,T(),!0;if(e==="ArrowRight"||e==="KeyD")return g=(g+1)%_.length,T(),!0;if(e==="ArrowUp"||e==="KeyW")return g=Math.max(0,g-wn()),T(),!0;if(e==="ArrowDown"||e==="KeyS")return g=Math.min(_.length-1,g+wn()),T(),!0;if(e==="Enter"||e==="Space")return le(),!0;const n=/^(?:Digit|Numpad)([1-9])$/.exec(e);if(n){const a=Number(n[1])-1;return a<_.length&&(g=a,T(),le()),!0}return!0},tabs:()=>R.filter(e=>!Y.has(e.id)&&e.gear).map(e=>e.id),pages:()=>R.filter(e=>!Y.has(e.id)&&!e.gear).map(e=>e.id),tab:()=>y().id,setTab:(e,n)=>{const a=R.findIndex(o=>o.id===e);return a>=0&&be(a),n&&n.search&&Ge(),y().id},filter:()=>c,setFilter:e=>(c=e,g=0,Ie(),c),items:()=>_.map(e=>e.id),selected:()=>_[g]?_[g].id:null,equipped:()=>({...C}),noteEquipped(e,n){C[e]!==void 0&&(C[e]=n,A&&(se(),mt()))}}}export{Ti as createInventory,Qn as fzfMatch};
